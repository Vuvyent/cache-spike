    ...
    debug_module(this, dm_config)
{
  ...
  debug_cache = new cache_t(4, 2, 64, "debug cache", this);
  debug_mmu = new mmu_t(this, cfg->endianness, NULL, debug_cache);
...
char* sim_t::addr_to_mem(reg_t paddr) {
  //std::cout<<"addr to mem is called\n";
  if (!paddr_ok(paddr))
    return NULL;
  ...
  if (auto mem = dynamic_cast<abstract_mem_t*>(desc.second))
    ...
    {
     // std::cout<<"addr contents is called\n";
